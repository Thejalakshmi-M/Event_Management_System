            ...
            children: [
              DrawerHeader(
                ...
                child: Column(children: [
                  ...
                  CircleAvatar(
                    radius: 29,
                    backgroundImage: photo_.isNotEmpty ? NetworkImage(photo_) : null, // Avoid errors if photo_ is empty
                    child: GestureDetector(
                      onTap: () async {
                        await Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => ViewProfilePage(title: 'View Profile')),
                        );
                        getdata(); // Reload data after returning from ViewProfilePage
                      },
                    ),
                  ),
...
//                 GestureDetector(
//                   onTap: () async {
//                     final Uri phoneUri = Uri(scheme: 'tel', path: '9745383526'); // Replace with your phone number

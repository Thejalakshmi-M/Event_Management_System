...
//                                   padding: EdgeInsets.all(5),
//                                   child: Text(
//                                     "Service Fee: ${servicefees_[index]}",
//                                     style: TextStyle(color: Colors.green, fontSize: 16), // Change 16 to your desired size
//                                   ),
//
//                                 ),
//                                 // SizedBox(height: 8),
...
import 'book.dart'; // Ensure this import is correct for your project
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoading
          ...
          : servicename_.isEmpty
          ? Center(child: Text("No services available.")) // Show message if no data
          : ListView.builder(
        physics: BouncingScrollPhysics(),
        itemCount: servicename_.length,
        itemBuilder: (BuildContext context, int index) {
